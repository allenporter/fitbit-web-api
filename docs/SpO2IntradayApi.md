...
> GetSpO2IntradayResponse get_sp_o2_intraday_by_date(var_date)
...
async with fitbit_web_api.ApiClient(configuration) as api_client:
    ...
    try:
        # Get SpO2 Intraday by Date
        api_response = await api_instance.get_sp_o2_intraday_by_date(var_date)
        print("The response of SpO2IntradayApi->get_sp_o2_intraday_by_date:\n")
        pprint(api_response)
...
[**GetSpO2IntradayResponse**](GetSpO2IntradayResponse.md)
...
> GetSpO2IntradayResponse get_sp_o2_intraday_by_interval(start_date, end_date)
...
async with fitbit_web_api.ApiClient(configuration) as api_client:
    ...
    try:
        # Get SpO2 Intraday by Interval
        api_response = await api_instance.get_sp_o2_intraday_by_interval(start_date, end_date)
        print("The response of SpO2IntradayApi->get_sp_o2_intraday_by_interval:\n")
        pprint(api_response)
    except Exception as e:
