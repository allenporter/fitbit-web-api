...
> GetHrvSummaryResponse get_hrv_summary_date(var_date)
...
async with fitbit_web_api.ApiClient(configuration) as api_client:
    ...
    try:
        # Get HRV Summary by Date
        api_response = await api_instance.get_hrv_summary_date(var_date)
        print("The response of HeartRateVariabilityApi->get_hrv_summary_date:\n")
        pprint(api_response)
...
[**GetHrvSummaryResponse**](GetHrvSummaryResponse.md)
...
> GetHrvSummaryResponse get_hrv_summary_interval(start_date, end_date)
...
async with fitbit_web_api.ApiClient(configuration) as api_client:
    ...
    try:
        # Get HRV Summary by Interval
        api_response = await api_instance.get_hrv_summary_interval(start_date, end_date)
        print("The response of HeartRateVariabilityApi->get_hrv_summary_interval:\n")
        pprint(api_response)
    except Exception as e:
