...
> GetHrvIntradayResponse get_hrv_intraday_by_date(var_date)
...
async with fitbit_web_api.ApiClient(configuration) as api_client:
    ...
    try:
        # Get HRV Intraday by Date
        api_response = await api_instance.get_hrv_intraday_by_date(var_date)
        print("The response of HeartRateVariabilityIntradayApi->get_hrv_intraday_by_date:\n")
        pprint(api_response)
...
[**GetHrvIntradayResponse**](GetHrvIntradayResponse.md)
...
> GetHrvIntradayResponse get_hrv_intraday_by_interval(start_date, end_date)
...
async with fitbit_web_api.ApiClient(configuration) as api_client:
    ...
    try:
        # Get HRV Intraday by Interval
        api_response = await api_instance.get_hrv_intraday_by_interval(start_date, end_date)
        print("The response of HeartRateVariabilityIntradayApi->get_hrv_intraday_by_interval:\n")
        pprint(api_response)
    except Exception as e:
