...
class GetIrnAlertsListResponse(BaseModel):
    """
    GetIrnAlertsListResponse
    """

    alerts: Optional[List[IrnAlert]] = Field(
        default=None, description="List of IRN alerts."
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "alerts": [IrnAlert.from_dict(_item) for _item in obj["alerts"]]
