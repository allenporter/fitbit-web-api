...
class Subscription(BaseModel):
    ...
    collection_type: Optional[StrictStr] = Field(
        default=None,
        description="The collection type of the subscription.",
        alias="collectionType",
    )
    owner_id: Optional[StrictStr] = Field(
        default=None, description="The owner ID of the subscription.", alias="ownerId"
    )
    owner_type: Optional[StrictStr] = Field(
        default=None,
        description="The owner type of the subscription.",
        alias="ownerType",
    )
    subscriber_id: Optional[StrictStr] = Field(
        default=None,
        description="The subscriber ID of the subscription.",
        alias="subscriberId",
    )
    subscription_id: Optional[StrictStr] = Field(
        default=None, description="The subscription ID.", alias="subscriptionId"
    )
