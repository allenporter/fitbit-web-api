...
class GetBreathingRateIntradayResponse(BaseModel):
    """
    GetBreathingRateIntradayResponse
    """

    br: Optional[List[GetBreathingRateIntradayResponseBrInner]] = None
    __properties: ClassVar[List[str]] = ["br"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "br": [
                    GetBreathingRateIntradayResponseBrInner.from_dict(_item)
                    for _item in obj["br"]
                ]
