...
class GetIrnProfileResponse(BaseModel):
    """
    GetIrnProfileResponse
    """

    onboarded: Optional[StrictBool] = Field(
        default=None,
        description="Whether or not the user has onboarded onto the IRN feature.",
    )
    enrolled: Optional[StrictBool] = Field(
        default=None,
    ...
    __properties: ClassVar[List[str]] = ["onboarded", "enrolled", "lastUpdated"]
