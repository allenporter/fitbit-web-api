...
class LeaderboardFriend(BaseModel):
    """
    LeaderboardFriend
    """
    ...
    id: Optional[StrictStr] = Field(default=None, description="Fitbit user id.")
    attributes: Optional[LeaderboardFriendAttributes] = None
    relationships: Optional[LeaderboardFriendRelationships] = None
        ...
        _obj = cls.model_validate(
            {
                "type": obj.get("type"),
                "id": obj.get("id"),
                "attributes": LeaderboardFriendAttributes.from_dict(obj["attributes"])
                if obj.get("attributes") is not None
                else None,
                "relationships": LeaderboardFriendRelationships.from_dict(
                    obj["relationships"]
                )
