...
class LifetimeStats(BaseModel):
    ...
    best: Optional[LifetimeStatsBest] = None
    lifetime: Optional[LifetimeStatsLifetime] = None
    __properties: ClassVar[List[str]] = ["best", "lifetime"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of best
        if self.best:
