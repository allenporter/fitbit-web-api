...
class HrvIntradayMinute(BaseModel):
    """
    HrvIntradayMinute
    """

    minute: Optional[StrictStr] = Field(
        default=None, description="A measurement taken at a given time."
    )
    value: Optional[HrvIntradayValue] = None
    __properties: ClassVar[List[str]] = ["minute", "value"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "value": HrvIntradayValue.from_dict(obj["value"])
