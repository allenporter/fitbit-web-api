...
class WeightLog(BaseModel):
    ...
    bmi: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="Calculated BMI."
    )
    var_date: Optional[date] = Field(
        default=None, description="Log entry date.", alias="date"
    )
    ...
    source: Optional[StrictStr] = Field(
        default=None, description="The source of the weight log."
    )
    time: Optional[StrictStr] = Field(
        default=None, description="Time of the measurement."
    )
