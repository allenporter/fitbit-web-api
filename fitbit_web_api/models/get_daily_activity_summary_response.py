...
class GetDailyActivitySummaryResponse(BaseModel):
    """
    GetDailyActivitySummaryResponse
    """

    activities: Optional[List[ActivityLog]] = Field(
        default=None, description="List of activity log entries."
    )
    goals: Optional[ActivityGoals] = None
    summary: Optional[ActivitySummary] = None
    __properties: ClassVar[List[str]] = ["activities", "goals", "summary"]
