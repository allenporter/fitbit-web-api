...
class LifetimeStatsLifetime(BaseModel):
    """
    The user's lifetime stats.
    """

    total: Optional[LifetimeStatsLifetimeTotal] = None
    tracker: Optional[LifetimeStatsLifetimeTracker] = None
    __properties: ClassVar[List[str]] = ["total", "tracker"]
