...
class LeaderboardFriendRelationships(BaseModel):
    """
    LeaderboardFriendRelationships
    """

    user: Optional[LeaderboardFriendRelationshipsUser] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "user": LeaderboardFriendRelationshipsUser.from_dict(obj["user"])
