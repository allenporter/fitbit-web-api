...
class LeaderboardFriendRelationshipsUser(BaseModel):
    """
    LeaderboardFriendRelationshipsUser
    """

    data: Optional[LeaderboardFriendRelationshipsUserData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "data": LeaderboardFriendRelationshipsUserData.from_dict(obj["data"])
