...
class GetMealResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["meal"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of meal
        if self.meal:
            _dict["meal"] = self.meal.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "meal": Meal.from_dict(obj["meal"])
                if obj.get("meal") is not None
                else None
            }
        )
        return _obj
