...
class HeartRateIntradayDataset(BaseModel):
    """
    HeartRateIntradayDataset
    """

    dataset: Optional[List[HeartRateIntradayDatapoint]] = None
    dataset_interval: Optional[StrictInt] = Field(
        default=None,
        description="The requested detail-level numerical interval",
        alias="datasetInterval",
    )
    dataset_type: Optional[StrictStr] = Field(
        default=None,
        description="The requested detail-level unit of measure",
        alias="datasetType",
    )
    __properties: ClassVar[List[str]] = ["dataset", "datasetInterval", "datasetType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "dataset": [
                    HeartRateIntradayDatapoint.from_dict(_item)
                    for _item in obj["dataset"]
                ]
                if obj.get("dataset") is not None
                else None,
                "datasetInterval": obj.get("datasetInterval"),
