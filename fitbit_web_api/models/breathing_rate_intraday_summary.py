...
class BreathingRateIntradaySummary(BaseModel):
    """
    BreathingRateIntradaySummary
    """

    breathing_rate: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None,
        description="Average number of breaths taken per minute.",
        alias="breathingRate",
    )
    __properties: ClassVar[List[str]] = ["breathingRate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"breathingRate": obj.get("breathingRate")})
        return _obj
