...
class HeartRateTimeSeriesDatapoint(BaseModel):
    """
    HeartRateTimeSeriesDatapoint
    """

    date_time: Optional[date] = Field(
        default=None, description="Date of the heart rate log.", alias="dateTime"
    )
    value: Optional[HeartRateTimeSeriesValue] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "value": HeartRateTimeSeriesValue.from_dict(obj["value"])
