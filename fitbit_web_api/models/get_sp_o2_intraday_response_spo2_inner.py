...
class GetSpO2IntradayResponseSpo2Inner(BaseModel):
    """
    ...
    minutes: Optional[List[SpO2IntradayMinute]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "minutes": [
                    SpO2IntradayMinute.from_dict(_item) for _item in obj["minutes"]
                ]
