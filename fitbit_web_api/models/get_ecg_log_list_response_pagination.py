...
class GetEcgLogListResponsePagination(BaseModel):
    """
    ...
    limit: Optional[StrictInt] = Field(
        default=None, description="The limit parameter of the request."
    )
    ...
    offset: Optional[StrictInt] = Field(
        default=None, description="The offset parameter of the request."
    )
    ...
    sort: Optional[StrictStr] = Field(
        default=None, description="The sort parameter of the request."
    )
