...
class HrvValue(BaseModel):
    ...
    deep_rmssd: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None,
    ...
    __properties: ClassVar[List[str]] = ["dailyRmssd", "deepRmssd"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"dailyRmssd": obj.get("dailyRmssd"), "deepRmssd": obj.get("deepRmssd")}
        )
        return _obj
