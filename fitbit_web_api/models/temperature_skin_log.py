...
class TemperatureSkinLog(BaseModel):
    """
    TemperatureSkinLog
    """

    date_time: Optional[date] = Field(
        default=None, description="The log date.", alias="dateTime"
    )
    ...
    value: Optional[TemperatureSkinLogValue] = None
    __properties: ClassVar[List[str]] = ["dateTime", "logType", "value"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "value": TemperatureSkinLogValue.from_dict(obj["value"])
