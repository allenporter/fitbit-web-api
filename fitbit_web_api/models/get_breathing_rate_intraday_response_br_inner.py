...
class GetBreathingRateIntradayResponseBrInner(BaseModel):
    """
    GetBreathingRateIntradayResponseBrInner
    """

    date_time: Optional[date] = Field(default=None, alias="dateTime")
    value: Optional[BreathingRateIntradayValue] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "value": BreathingRateIntradayValue.from_dict(obj["value"])
