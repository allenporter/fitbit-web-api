...
class GetHrvIntradayResponseHrvInner(BaseModel):
    """
    GetHrvIntradayResponseHrvInner
    """

    date_time: Optional[date] = Field(default=None, alias="dateTime")
    minutes: Optional[List[HrvIntradayMinute]] = None
    __properties: ClassVar[List[str]] = ["dateTime", "minutes"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "minutes": [
                    HrvIntradayMinute.from_dict(_item) for _item in obj["minutes"]
                ]
